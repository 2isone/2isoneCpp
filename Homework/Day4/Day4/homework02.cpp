...
/*
	강사님 피드백
	잘 했음, 과제 진행하면서 생긴 의문점들은 아직 안 배운 문법이 있어서 수도코드대로 의미를
	펼치는 데에 제약사항이 생겨 잇몸으로 해결하다 보니 생긴 문제점들로 보임
	의문점들은 빠르면 5일차(수요일), 늦으면 6일차(금요일)에 수업할 내용이니 참고
	수도코드도 잘 작성했고 이대로만 하면 될 것 같음
*/